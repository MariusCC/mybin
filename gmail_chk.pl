...
#      COMPANY:  
#      VERSION:  1.0
#      CREATED:  12/13/2008 08:14:48 PM EET
#     REVISION:  ---
#===============================================================================
...
my ($new, @from, $text, @subj);

my $user="mariuscristianc"; #username for gmail account
my $pass="!ntr4.D0s"; #password for gmail account
my $file="/tmp/gmail.html"; #temporary file to store gmail

#wrap format for subject
$Text::Wrap::columns=65; #Number of columns to wrap subject at
my $initial_tab=""; #Tab for first line of subject
my $subsequent_tab="\t"; #tab for wrapped lines
my $quote="\""; #put quotes around subject

#limit the number of emails to be displayed
my $emails=4; #if -1 display all emails
